...
class DerelictAllegro5Loader : SharedLibLoader
{
    ...
    protected override void loadSymbols()
    {
        ...
        bindFunc(cast(void**)&al_reset_clipping_rectangle, "al_reset_clipping_rectangle");
        ...
        bindFunc(cast(void**)&al_get_bitmap_x, "al_get_bitmap_x");
        bindFunc(cast(void**)&al_get_bitmap_y, "al_get_bitmap_y");
        bindFunc(cast(void**)&al_reparent_bitmap, "al_reparent_bitmap");
        bindFunc(cast(void**)&al_clone_bitmap, "al_clone_bitmap");
        bindFunc(cast(void**)&al_convert_bitmap, "al_convert_bitmap");
        bindFunc(cast(void**)&al_convert_memory_bitmaps, "al_convert_memory_bitmaps");
        ...
        bindFunc(cast(void**)&al_draw_tinted_scaled_rotated_bitmap_region, "al_draw_tinted_scaled_rotated_bitmap_region");
        ...
        bindFunc(cast(void**)&al_register_bitmap_identifier, "al_register_bitmap_identifier");
        bindFunc(cast(void**)&al_load_bitmap, "al_load_bitmap");
        bindFunc(cast(void**)&al_load_bitmap_flags, "al_load_bitmap_flags");
        bindFunc(cast(void**)&al_load_bitmap_f, "al_load_bitmap_f");
        bindFunc(cast(void**)&al_load_bitmap_flags_f, "al_load_bitmap_flags_f");
        bindFunc(cast(void**)&al_save_bitmap, "al_save_bitmap");
        bindFunc(cast(void**)&al_save_bitmap_f, "al_save_bitmap_f");
        bindFunc(cast(void**)&al_identify_bitmap_f, "al_identify_bitmap_f");
        bindFunc(cast(void**)&al_identify_bitmap, "al_identify_bitmap");
        bindFunc(cast(void**)&al_lock_bitmap, "al_lock_bitmap");
        bindFunc(cast(void**)&al_lock_bitmap_region, "al_lock_bitmap_region");
        bindFunc(cast(void**)&al_lock_bitmap_blocked, "al_lock_bitmap_blocked");
        bindFunc(cast(void**)&al_lock_bitmap_region_blocked, "al_lock_bitmap_region_blocked");
        ...
        bindFunc(cast(void**)&al_set_blend_color, "al_set_blend_color");
        bindFunc(cast(void**)&al_get_blender, "al_get_blender");
        bindFunc(cast(void**)&al_get_blend_color, "al_get_blend_color");
        ...
        bindFunc(cast(void**)&al_clipboard_has_text, "al_clipboard_has_text");
        bindFunc(cast(void**)&al_set_clipboard_text, "al_set_clipboard_text");
        bindFunc(cast(void**)&al_clipboard_has_text, "al_clipboard_has_text");
        ...
        bindFunc(cast(void**)&al_premul_rgba, "al_premul_rgba");
        bindFunc(cast(void**)&al_premul_rgba_f, "al_premul_rgba_f");
        ...
        bindFunc(cast(void**)&al_get_pixel_block_size, "al_get_pixel_block_size");
        bindFunc(cast(void**)&al_get_pixel_block_width, "al_get_pixel_block_width");
        bindFunc(cast(void**)&al_get_pixel_block_height, "al_get_pixel_block_height");
        ...
        bindFunc(cast(void**)&al_set_display_icons, "al_set_display_icons");
        ...
        bindFunc(cast(void**)&al_get_window_constraints, "al_get_window_constraints");
        ...
        bindFunc(cast(void**)&al_fread32le, "al_fread32le");
        bindFunc(cast(void**)&al_fread32be, "al_fread32be");
        ...
        bindFunc(cast(void**)&al_get_new_file_interface, "al_get_new_file_interface");
        bindFunc(cast(void**)&al_set_new_file_interface, "al_set_new_file_interface");
        bindFunc(cast(void**)&al_set_standard_file_interface, "al_set_standard_file_interface");
        ...
        bindFunc(cast(void**)&al_set_render_state, "al_set_render_state");
        bindFunc(cast(void**)&al_create_shader, "al_create_shader");
        bindFunc(cast(void**)&al_attach_shader_source, "al_attach_shader_source");
        bindFunc(cast(void**)&al_attach_shader_source_file, "al_attach_shader_source_file");
        bindFunc(cast(void**)&al_build_shader, "al_build_shader");
        bindFunc(cast(void**)&al_get_shader_log, "al_get_shader_log");
        bindFunc(cast(void**)&al_get_shader_platform, "al_get_shader_platform");
        bindFunc(cast(void**)&al_use_shader, "al_use_shader");
        bindFunc(cast(void**)&al_destroy_shader, "al_destroy_shader");
        bindFunc(cast(void**)&al_set_shader_sampler, "al_set_shader_sampler");
        bindFunc(cast(void**)&al_set_shader_matrix, "al_set_shader_matrix");
        bindFunc(cast(void**)&al_set_shader_int, "al_set_shader_int");
        bindFunc(cast(void**)&al_set_shader_float, "al_set_shader_float");
        bindFunc(cast(void**)&al_set_shader_int_vector, "al_set_shader_int_vector");
        bindFunc(cast(void**)&al_set_shader_float_vector, "al_set_shader_float_vector");
        bindFunc(cast(void**)&al_set_shader_bool, "al_set_shader_bool");
        bindFunc(cast(void**)&al_get_default_shader_source, "al_get_default_shader_source");
        ...
        bindFunc(cast(void**)&al_set_exe_name, "al_set_exe_name");
        ...
        bindFunc(cast(void**)&al_is_touch_input_installed, "al_is_touch_input_installed");
        bindFunc(cast(void**)&al_install_touch_input, "al_install_touch_input");
        bindFunc(cast(void**)&al_uninstall_touch_input, "al_uninstall_touch_input");
        bindFunc(cast(void**)&al_get_touch_input_state, "al_get_touch_input_state");
        bindFunc(cast(void**)&al_get_touch_input_event_source, "al_get_touch_input_event_source");
        bindFunc(cast(void**)&al_use_transform, "al_use_transform");
        bindFunc(cast(void**)&al_use_projection_transform, "al_use_projection_transform");
        ...
        bindFunc(cast(void**)&al_build_camera_transform, "al_build_camera_transform");
        bindFunc(cast(void**)&al_translate_transform, "al_translate_transform");
        bindFunc(cast(void**)&al_translate_transform_3d, "al_translate_transform_3d");
        bindFunc(cast(void**)&al_rotate_transform, "al_rotate_transform");
        bindFunc(cast(void**)&al_rotate_transform_3d, "al_rotate_transform_3d");
        bindFunc(cast(void**)&al_scale_transform, "al_scale_transform");
        bindFunc(cast(void**)&al_scale_transform_3d, "al_scale_transform_3d");
        bindFunc(cast(void**)&al_transform_coordinates, "al_transform_coordinates");
        bindFunc(cast(void**)&al_transform_coordinates_3d, "al_transform_coordinates_3d");
        ...
        bindFunc(cast(void**)&al_get_current_inverse_transform, "al_get_current_inverse_transform");
        bindFunc(cast(void**)&al_get_current_projection_transform, "al_get_current_projection_transform");
        bindFunc(cast(void**)&al_invert_transform, "al_invert_transform");
        bindFunc(cast(void**)&al_check_inverse, "al_check_inverse");
        bindFunc(cast(void**)&al_orthographic_transform, "al_orthographic_transform");
        bindFunc(cast(void**)&al_perspective_transform, "al_perspective_transform");
        bindFunc(cast(void**)&al_horizontal_shear_transform, "al_horizontal_shear_transform");
        bindFunc(cast(void**)&al_vertical_shear_transform, "al_vertical_shear_transform");
...
__gshared DerelictAllegro5Loader DerelictAllegro5;

shared static this() {
    DerelictAllegro5 = new DerelictAllegro5Loader;
}